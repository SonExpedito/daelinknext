...
import { auth, db, storage } from "./firebase"; // usando instâncias já inicializadas (singleton)
...
export const onAuthChange = (callback) => {
  // const auth = getAuth(); // já temos a instância importada; manter comentado para referência
  return onAuthStateChanged(auth, callback);
};

// Função para obter dados adicionais do usuário do Firestore
export const getUserData = async (uid) => {
  // const db = getFirestore(); // reutilizando db importado
