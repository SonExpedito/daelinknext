...
export default function MessageContainer({ participante, chat }: MessageContainerProps) {
    ...
    useEffect(() => {
        ...
        let firstLoad = true; // ✅ controle para saber se é a primeira vez
        ...
        const getMessages = async () => {
            try {
                ...
                // ✅ Se é o primeiro carregamento, sempre rola para o fim
                if (firstLoad) {
                    firstLoad = false;
                    ...
                    // ✅ Atualizações seguintes só se o usuário já estava no fim
                    requestAnimationFrame(() => {
