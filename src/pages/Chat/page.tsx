    ...
    return (
        <div className="w-full h-[84vh] flex justify-center items-center">
            {loading ? (
                ...
                <>
                    <div className="w-[35%] h-full flex flex-col  pt-20 gap-8 items-center ">
                        <button
                        ...
                        <div className="flex flex-col items-center justify-center gap-4">
                            <div className="h-32 flex items-center justify-center rounded-3xl p-1 border 
                    ...
                    <div className="w-[65%] h-full">
                        <h2 className="text-color">{chat.empresaId}</h2>
                        <p className="text-color">{chat.pcdId}</p>
                    </div>
